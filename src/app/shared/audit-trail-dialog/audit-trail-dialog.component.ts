...
export class AuditTrailDialogComponent implements OnInit,AfterViewInit {
  ...
  userList : any[] = [
    {module : "Customer Details",dataFeild : "Project Number",oldValue : "8776",newValue : "9569",changedBy : "Selvakumar",timestamp : "13/08/2020 17:08:21",remarks : "Customer Details Project Number Update"},
    ...
    {module  :"Technical Admin Details",dataFeild : "Official Address Line 1",changedBy : "Santhosh",oldValue : "Bhandup nagar,Mumbai",newValue:"MaharanaPratap Nagar,Mumbai",timestamp : "10/05/2020 14:10:32",remarks : "Address Update"},


    {module : "Billing Admin Detail",dataFeild : "Email Address",oldValue :"test@gmail.com",changedBy :"Robin karan",newValue :"nandhan156@yahoo.in",timestamp : "20/11/2020 11:30:45",remarks  :"Email Id Updated"},
    ...
    {module : "SMS Credt Alloction",dataFeild : "Status",oldValue : "Approved",newValue : "Reject",changedBy : "Ketan Parek", timestamp : "15/06/2020 16:00:00",remarks : "Status Updated"},
    ...
    {module : "Project Execution",dataFeild : "PI Paid",oldValue : "Partial Payment",newValue : "Full Payment",changedBy :"Abjieet",timestamp : "16/10/2020 12:20:30",remarks : "PI amount Paid Updated"},



    {module : "Proforma Invoice",dataFeild : "Proforma Invoice Number",oldValue : "4355",newValue : "8945",changedBy : "Akshaya",timestamp : "02/01/2020 13:01:55",remarks : "Testing"},
    ...
    {module : "Tax Invoice",dataFeild : "Penalty",oldValue : "2000",newValue : "2500",changedBy : "Raja Priyan",timestamp : "25/02.2020 08:10:10",remarks : "Penalty Applied"},
